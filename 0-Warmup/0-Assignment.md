...
1. Select with an `x` the platform you will be using for your course deliverables:
    ...
    - [ ] Orbstack on MacOs
    - [ ] VMWare Fusion
    - [X] Somthing else (Arch Linux on Laptop)
...
[https://github.com/Ian-B-Kennedy/CS283](https://github.com/Ian-B-Kennedy/CS283)

4. Briefly describe what you want to get out of this class.

I would like to reinforce my understanding of systems programming as I have taken a similar course before under the college of engineering. I would also like to reinforce my skills in C as well as that is always something useful.

5. Briefly describe any concerns you might be having with being successful in this class (if any).

I don't really have any concerns with being successful in this class.
